...
I got really into listening to Phish over the last year or so, and I wanted
something that would let me put audience recordings from
link:https://phish.in[Phish.in] into my music library without much effort.
Naturally, it turned into a lot of effort because I was having fun with the
design of the tools. Here's the idea:

----
$ phishin-list-shows -y 
$ phish-show-notes 
----
