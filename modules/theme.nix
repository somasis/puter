...
{
  options.theme = {
    enable = mkEnableOption "a rudimentary color palette configuration module";
    ...
    colors = mkOption {
      ...
      default = {
        ...
        purple = mkThemeColorOption "purple" "#b218b2";
        ...
        brightPurple = mkThemeColorOption "brightPurple" "#ff54ff";
  ...
  #   (mkAliasOptionModule [ "theme" "colors" "color5" ] [ "theme" "colors" "purple" ])
  ...
  #   (mkAliasOptionModule [ "theme" "colors" "color13" ] [ "theme" "colors" "brightPurple" ])
  ...
  config = mkIf cfg.enable {
    xresources.properties =
      with cfg.colors;
      {
        ...
        "*colorBrightPurple" = brightPurple;
